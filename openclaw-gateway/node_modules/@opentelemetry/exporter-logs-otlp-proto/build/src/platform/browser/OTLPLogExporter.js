 ...
 */
class OTLPLogExporter extends otlp_proto_exporter_base_1.OTLPProtoExporterBrowserBase {
    constructor(config = {}) {
        super(config);
        this._headers = Object.assign(this._headers, core_1.baggageUtils.parseKeyPairsIntoRecord((0, core_1.getEnv)().OTEL_EXPORTER_OTLP_LOGS_HEADERS));
    }
    convert(logs) {
        return (0, otlp_transformer_1.createExportLogsServiceRequest)(logs);
    }
    ...
    getServiceClientType() {
        return otlp_proto_exporter_base_1.ServiceClientType.LOGS;
    }
}
