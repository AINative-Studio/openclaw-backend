...
class DBOSExecutor {
    ...
    constructor(config, { systemDatabase } = {}) {
        ...
        if (systemDatabase) {
            ...
            this.systemDatabase = new system_database_1.SystemDatabase(this.config.systemDatabaseUrl, this.logger, this.serializer, this.config.sysDbPoolSize, this.config.systemDatabasePool, this.systemDBSchemaName, this.config.useListenNotify);
        }
    ...
    static reviveResultOrError(r, serializer) {
        if (r.error) {
            throw (0, serialization_1.deserializeResError)(r.error, r.serialization ?? null, serializer);
        }
        return (0, serialization_1.deserializeValue)(r.output ?? null, r.serialization ?? null, serializer);
    }
    ...
    async internalWorkflow(wf, params, callerID, callerFunctionID, ...args) {
        ...
        const funcArgs = (0, serialization_1.serializeFunctionInputOutput)(serializationType === 'portable' ? { positionalArgs: args } : args, [wfname, '<arguments>'], this.serializer, serializationType);
        args =
        ...
        if (callerFunctionID !== undefined && callerID !== undefined) {
            ...
            if (result) {
                if (result.error) {
                    throw (0, serialization_1.deserializeResError)(result.error, result.serialization ?? null, this.serializer);
                }
        ...
        try {
            ...
            if (e instanceof error_1.DBOSQueueDuplicatedError && callerID && callerFunctionID) {
                const sererr = (0, serialization_1.serializeResError)(e, this.serializer, undefined); // This is a step result
                await this.systemDatabase.recordOperationResult(callerID, callerFunctionID, internalStatus.workflowName, true, Date.now(), { error: sererr.serializedValue, serialization: sererr.serialization });
            }
            throw e;
        }
        if (callerFunctionID !== undefined && callerID !== undefined) {
        ...
        async function handleWorkflowError(err, exec) {
            ...
            const sererr = (0, serialization_1.serializeResErrorWithSerializer)(e, eserializer, ires.serialization ?? null);
            ...
            return (0, serialization_1.deserializeResError)(sererr.serializedValue, sererr.serialization, eserializer);
        }
        const runWorkflow = async () => {
            ...
            try {
                ...
                result = callResult;
                const funcResult = (0, serialization_1.serializeFunctionInputOutputWithSerializer)(result, [wfname, '<result>'], this.serializer, ires.serialization);
    ...
    async getEvent(workflowUUID, key, timeoutSeconds = DBOSExecutor.defaultNotificationTimeoutSec) {
        ...
        return (0, serialization_1.deserializeValue)(evt.serializedValue, evt.serialization, this.serializer);
    }
    /**
     * Fork a workflow.
    ...
    async executeWorkflowId(workflowID, options) {
        ...
        let inputs;
        try {
            inputs = (0, serialization_1.deserializePositionalArgs)(wfStatus.input, wfStatus.serialization, this.serializer);
        }
        catch (err) {
            ...
            const sererr = (0, serialization_1.serializeResErrorWithSerializer)(err, this.serializer, wfStatus.serialization);
        ...
        if (nameArr[1] === exports.TempWorkflowType.step) {
            ...
            const swf = async (destinationID, message, topic, serialization) => {
                ...
                const sermsg = (0, serialization_1.serializeValue)(message, this.serializer, serialization ?? undefined);
