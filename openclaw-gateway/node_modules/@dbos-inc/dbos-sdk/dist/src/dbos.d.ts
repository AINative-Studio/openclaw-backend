...
import { GetWorkflowsInput, StepInfo, WorkflowConfig, WorkflowHandle, WorkflowSerializationFormat, WorkflowStatus } from './workflow';
...
import { EnqueueOptions, VersionInfo } from './system_database';
import { WorkflowSchedule, ScheduledWorkflowFn } from './scheduler/scheduler';
...
export declare class DBOS {
     ...
     */
    static waitFirst(handles: WorkflowHandle<unknown>[]): Promise<WorkflowHandle<unknown>>;
    /**
