...
async function ensureSystemDatabase(sysDbUrl, logger, customPool, schemaName = 'dbos', useListenNotify = true) {
    ...
    try {
        await (0, migration_runner_1.runSysMigrationsPg)(client, (0, migrations_1.allMigrations)(schemaName, { useListenNotify }), schemaName, {
...
class SystemDatabase {
    ...
    async findAndMarkStartableWorkflows(queue, executorID, appVersion, queuePartitionKey) {
        ...
        try {
           ...
           WHERE queue_name = $1
             ...
             ${partitionFilter.replace('$PARTITION', '$4')}`, params);
    ...
    async listSchedules(filters, client) {
        ...
        const result = await q.query(`SELECT schedule_id, schedule_name, workflow_name, workflow_class_name, schedule, status, context
