...
# Add the parent directory to the path so we can import our backend modules
...
from backend.models.audit_event import AuditLogEntry
...
# Convert asyncpg URLs to psycopg2 for synchronous Alembic migrations
